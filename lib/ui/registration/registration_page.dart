                        ...
                        Padding(
                            ...
                            child: Form(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    Text("Daftar", style: mediumText28,),
                                    ...
                                    CustomTextField(
                                        ...
                                        validator: (formEmail) {
                                          if (_isDaftarClicked && (formEmail==null || formEmail.isEmpty)) {
                                    ...
                                    CustomTextField(
                                        ...
                                        validator: (passwordForm) {
                                          if (_isDaftarClicked && (passwordForm==null || passwordForm.isEmpty)) {
                                            return 'Masukkan kata sandi anda';
                                          }
                                          return ValidationHelpers.validatePassword(passwordForm ?? '');
                                        },
                                    ...
                                    CustomTextField(
                                        ...
                                        validator: (konfirmasiPass) {
                                          if (_isDaftarClicked && (konfirmasiPass==null || konfirmasiPass.isEmpty)) {
                                            return 'Masukkan kembali kata sandi anda';
                                          }
                                          return ValidationHelpers.validateConfirmPassword(confirmPassword: _konfirmasiForm.text, password: _passForm.text);
                                        },
                                      onPressedIconPassword: () {
                                        setState(() {
                            ...
                            child: Column(
                              children: [
                                CustomElevatedButton(
                                    ...
                                    minHeight: 47,
                                    backgroundColor: isPassEmpty || isKonfirmasiEmpty || isEmailEmpty
                                    ? const Color(0xFF001449).withOpacity(0.5) : Color(0xFF001449),
                                    borderRadius: 8,
                                ),
                                ...
                                Row(
                                  ...
                                  const Text("Sudah punya Akun?"),
                                    ...
                                    GestureDetector(
                                      ...
                                      child: Text("Masuk", style: boldUnderlineText14,),
                                    )
                                 ],
                                )
                              ],
